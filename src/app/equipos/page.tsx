  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] font-poppins text-slate-900">
      ...
      <section className="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="bg-white p-4 sm:p-5 rounded-[20px] border border-slate-200/80 shadow-sm mb-6 grid grid-cols-1 md:grid-cols-3 gap-3 items-center">
          <div className="relative md:col-span-2">
            <Search className="w-4 h-4 text-slate-400 absolute left-4 top-1/2 -translate-y-1/2" />
            <input
              type="text"
              placeholder="Buscar en toda la base de datos (equipo, marca, código, serie...)"
              value={searchTerm}
